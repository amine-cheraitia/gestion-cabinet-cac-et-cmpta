...
return [
    ...
    'custom'               => [
        ...
        'num_registre_commerce' => [
            "required" => "Le champ N° Registre de Commerce est obligatoire.",
        ],
    ...
    'attributes' => [
        'num_registre_commerce' => "Le champ N° Registre de Commerce est obligatoire.",
        'num_id_fiscale' => "N° d'Identification fiscal",
        'num art imposition' => "N° d'Article d'Imposition",
        'num tel' => "Numéro de télephone",
