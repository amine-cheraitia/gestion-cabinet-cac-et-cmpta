...
<button id="z" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
    Launch demo modal
</button>

<!-- Modal -->
<div class="modal fade shadow" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                {{-- modal planning --}}
                <form class="row g-3 needs-validation p-3" novalidate method="POST" action="{{route('mission.store')}}">
                    @csrf
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control shadow  {{-- @error('total')is-invalid
                            @enderror --}}" id="total" value="{{-- {{old('total')}} --}}" required name="total"
                            readonly="readonly">
                        {{-- @error('total')
                    ...
                    <div class="col-md-6">
                        ...
                        @enderror --}}" id="start" value="" required name="start">
                        {{-- @error('start')
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control shadow {{-- @error('end')is-invalid
                            ...
                            value="{{-- {{old('end')}} --}}" required name="end">
                        {{-- @error('end')
                    ...
                    <div class="col-md-6">
                        ...
                        @enderror --}}" id="textColor" value="{{-- {{old('num_art_imposition')}} --}}" required
                            name="textColor">
                        {{-- @error('textColor')
